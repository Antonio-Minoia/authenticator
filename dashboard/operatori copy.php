...
<body class="theme-<?= $_SESSION['user']['tema'] ?> preload-active aside-active aside-mobile-minimized aside-desktop-maximized" id="fullscreen">
    ...
    <? require_once('./modals/nuovooperatore.php') ?>
    <!-- END modals-->
    <!-- BEGIN Preload -->
    <div class="preload">
    ...
    <div class="holder">
            ...
            <div class="aside">
                <div class="aside-header">
                    <h2 class="aside-title"><?= $_SESSION['impostazioni']['nome_azienda'] ?><small class="text text-small"> gestione</small></h2>
                        ...
                        <div class="col-12">
                            ...
                            <div class="portlet">
                                <div class="portlet-header portlet-header-bordered">
                                    ...
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#modalNewOperatore">Nuovo Utente</button>
                                </div>
                                <div class="portlet-body">
                                    <!-- BEGIN Datatable -->
                                    <div id="table2" style="overflow-x:auto;">
                                        <? require_once("./tabellaoperatori.php"); ?>
    ...
    <script src="operatori.js"></script>
    <style>
        .td button {
            display: none;
        }
