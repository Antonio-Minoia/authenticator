...
function renderTabellaOperatori(action) {
  if (action == "rimuovi") {
    setTimeout(
      () => { },
  ...
  $("#table2").load("./tabellaoperatori.php", () => {
...
function nuovoOperatore() {
  ...
  if(qrvisibilita == "") {qrvisibilita == "1"};
  const preavviso = $("#preavviso2").val();
  if(preavviso == "") {preavviso == "0"};
  const tolleranza = $("#tolleranza2").val();
  if(tolleranza == "") {tolleranza == "0"};
  const ritardo = $("#ritardo2").val();
  if(ritardo == "") {ritardo == "15"};
  console.log("tolleranza:" + tolleranza + " "+preavviso + " "+qrvisibilita + " "+ ritardo)
...
$("#tipologia2").on("change", () => {
  if($("#tipologia2").val() == "0"){
    $("#qrvisibilita2").removeAttr("disabled");
    $("#tolleranza2").removeAttr("disabled");
    $("#ritardo2").removeAttr("disabled");
    $("#preavviso2").removeAttr("disabled");
    $("#orari2").removeAttr("hidden");
  } else {
    $("#qrvisibilita2").attr("disabled", true);
    $("#tolleranza2").attr("disabled", true);
    $("#ritardo2").attr("disabled", true);
    $("#preavviso2").attr("disabled", true);
    $("#orari2").attr("hidden", true);
